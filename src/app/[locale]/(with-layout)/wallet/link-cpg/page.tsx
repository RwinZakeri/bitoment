...
const LinkCpg = () => {
  ...
  const { mutate, isPending: isSubmitting } = useMutation({
    ...
    onSuccess: () => {
      toast.success(t("wallet.paymentLinkCreated"));
    },
    onError: (error: unknown) => {
      const errorMessage =
        (error as { response?: { data?: { message?: string } } })?.response
          ?.data?.message || t("wallet.failedToCreatePaymentLink");
  ...
  return (
    <PageLayout title={t("wallet.createPaymentLink")}>
      <form
      ...
      >
        ...
        <div>
          <CustomeInput
            ...
            error={errors.price?.message ? translateErrorMessage(errors.price.message, t) : undefined}
          />
        ...
        <div>
          <CustomeInput
            ...
            label={t("wallet.orderDescription")}
            inputType="stroke"
            type="text"
        ...
        <div className="mt-4 flex flex-col gap-4">
          ...
          <Checkbox
            id="multiple-payment"
            label={t("wallet.multiplePayment")}
